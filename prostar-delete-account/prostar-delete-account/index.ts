...
const SUPABASE_URL = Deno.env.get('https://agechujhqhbmuenncwtb.supabase.co');
const SERVICE_ROLE_KEY = Deno.env.get('sb_publishable_HbCn6NL--T-Q6556_l0SIw_7QBgMUx3');
